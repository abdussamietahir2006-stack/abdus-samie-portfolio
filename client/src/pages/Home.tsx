          ...
          <div className="max-w-3xl">
            ...
            >
              <div className="flex items-center gap-4 group">
                <div className="p-3 bg-slate-900 rounded-2xl group-hover:bg-emerald-600 transition-colors border border-white/5">
              ...
              <div className="flex items-center gap-4 group">
                <div className="p-3 bg-slate-900 rounded-2xl group-hover:bg-fuchsia-600 transition-colors border border-white/5">
              ...
              <div className="flex items-center gap-4 group">
                <div className="p-3 bg-slate-900 rounded-2xl group-hover:bg-amber-600 transition-colors border border-white/5">
